...
class UserBot(Base):
    ...
    # 群成员可用工具白名单；默认开放联网搜索 + 图片搜索，不暴露用户私有内容和写操作。
    group_allowed_tools: Mapped[Optional[list]] = mapped_column(JSON, nullable=True, default=lambda: ["web_search", "image_search"])
