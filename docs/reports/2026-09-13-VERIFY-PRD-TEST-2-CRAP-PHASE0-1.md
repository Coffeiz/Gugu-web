...
> 报告日期：2026-09-13
> Commit：0bdc6f877564ee8b6323e53a688c2e01942ba5d3（工作区修改：是）
...
|---|---|---|---|---|---|---|
| python | [backend/agent/context/budget.py](../../backend/agent/context/budget.py) | [backend/tests/test_context_budget.py](../../backend/tests/test_context_budget.py), [backend/tests/test_session_history.py](../../backend/tests/test_session_history.py) | Agent 上下文预算 / L0 单元测试 | 普通 pytest 随 runtime-integration 自动执行；CRAP 报告与变异测试仅周期性手动运行，不由 CI 自动触发 | passed | 1351 ms |
| typescript | [frontend/src/utils/optimisticMutation.ts](../../frontend/src/utils/optimisticMutation.ts) | [frontend/test/optimisticMutation.test.ts](../../frontend/test/optimisticMutation.test.ts) | 文件库乐观更新时序 / L0 单元测试 | 普通 Vitest 随 runtime-integration 自动执行；CRAP 报告与变异测试仅周期性手动运行，不由 CI 自动触发 | passed | 2993 ms |

## CRAP 明细

| 风险 | CRAP | CC | Cov | 函数 | 源码位置 | 函数级测试关联 |
|---|---:|---:|---:|---|---|---|
| 高 | 342.0000 | 18 | 0.0% | enforce_provider_overflow_fallback | [backend/agent/context/budget.py:421](../../backend/agent/context/budget.py#L421) | 待人工关联 |
| 高 | 30.6075 | 30 | 91.2% | truncate_messages | [backend/agent/context/budget.py:286](../../backend/agent/context/budget.py#L286) | [backend/tests/test_context_budget.py](../../backend/tests/test_context_budget.py) |
| 中 | 19.1195 | 6 | 28.6% | _truncate_value | [backend/agent/context/budget.py:265](../../backend/agent/context/budget.py#L265) | 待人工关联 |
| 低 | 12.0000 | 3 | 0.0% | is_context_overflow_error | [backend/agent/context/budget.py:483](../../backend/agent/context/budget.py#L483) | 待人工关联 |
...
| 低 | 5.0000 | 5 | 100.0% | _units | [backend/agent/context/budget.py:226](../../backend/agent/context/budget.py#L226) | 待人工关联 |
| 低 | 4.2500 | 4 | 75.0% | _fit_oversized_message | [backend/agent/context/budget.py:275](../../backend/agent/context/budget.py#L275) | 待人工关联 |
| 低 | 4.0120 | 4 | 90.9% | _truncate_text | [backend/agent/context/budget.py:249](../../backend/agent/context/budget.py#L249) | 待人工关联 |
...
| 低 | 3.0988 | 3 | 77.8% | enforce_message_budget | [backend/agent/context/budget.py:392](../../backend/agent/context/budget.py#L392) | [backend/tests/test_context_budget.py](../../backend/tests/test_context_budget.py) |
...
| 低 | 3.0000 | 3 | 100.0% | optimisticMutation | [frontend/src/utils/optimisticMutation.ts:41](../../frontend/src/utils/optimisticMutation.ts#L41) | [frontend/test/optimisticMutation.test.ts](../../frontend/test/optimisticMutation.test.ts) |
...
| 低 | 2.0000 | 1 | 0.0% | atomic_message_units | [backend/agent/context/budget.py:244](../../backend/agent/context/budget.py#L244) | 待人工关联 |
