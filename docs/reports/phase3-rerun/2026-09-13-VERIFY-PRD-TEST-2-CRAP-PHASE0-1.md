...
|---|---|---|---|---|---|---|
| python | [backend/agent/context/budget.py](../../backend/agent/context/budget.py) | [backend/tests/test_context_budget.py](../../backend/tests/test_context_budget.py), [backend/tests/test_session_history.py](../../backend/tests/test_session_history.py) | Agent 上下文预算 / L0 单元测试 | 普通 pytest 随 runtime-integration 自动执行；CRAP 报告与变异测试仅周期性手动运行，不由 CI 自动触发 | passed | 1683 ms |
| typescript | [frontend/src/utils/optimisticMutation.ts](../../frontend/src/utils/optimisticMutation.ts) | [frontend/test/optimisticMutation.test.ts](../../frontend/test/optimisticMutation.test.ts) | 文件库乐观更新时序 / L0 单元测试 | 普通 Vitest 随 runtime-integration 自动执行；CRAP 报告与变异测试仅周期性手动运行，不由 CI 自动触发 | passed | 3002 ms |

## CRAP 明细

| 风险 | CRAP | CC | Cov | 函数 | 源码位置 | 函数级测试关联 |
|---|---:|---:|---:|---|---|---|
| 高 | 342.0000 | 18 | 0.0% | enforce_provider_overflow_fallback | [backend/agent/context/budget.py:428](../../backend/agent/context/budget.py#L428) | 待人工关联 |
| 高 | 30.6075 | 30 | 91.2% | truncate_messages | [backend/agent/context/budget.py:293](../../backend/agent/context/budget.py#L293) | [backend/tests/test_context_budget.py](../../backend/tests/test_context_budget.py) |
| 中 | 19.1195 | 6 | 28.6% | _truncate_value | [backend/agent/context/budget.py:272](../../backend/agent/context/budget.py#L272) | 待人工关联 |
| 低 | 12.0000 | 3 | 0.0% | is_context_overflow_error | [backend/agent/context/budget.py:490](../../backend/agent/context/budget.py#L490) | 待人工关联 |
...
| 低 | 4.2500 | 4 | 75.0% | _fit_oversized_message | [backend/agent/context/budget.py:282](../../backend/agent/context/budget.py#L282) | 待人工关联 |
| 低 | 4.0120 | 4 | 90.9% | _truncate_text | [backend/agent/context/budget.py:256](../../backend/agent/context/budget.py#L256) | 待人工关联 |
...
| 低 | 3.0988 | 3 | 77.8% | enforce_message_budget | [backend/agent/context/budget.py:399](../../backend/agent/context/budget.py#L399) | [backend/tests/test_context_budget.py](../../backend/tests/test_context_budget.py) |
