...
import { extractAccent } from '@/views/Calendar/utils/calendarColors'
import { normalizeEvent, normalizeProjectTimeline, toRenderItem } from '@/views/Calendar/domain/calendarNormalizer'
