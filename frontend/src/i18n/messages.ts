...
export const messages = {
  'zh-CN': { ...zhCN, terminalUi: terminalUi['zh-CN'], filesUi: filesUi['zh-CN'], filesViewUi: filesViewUi['zh-CN'], profileGuguUi: profileGuguUi['zh-CN'], chatUi: chatUi['zh-CN'], perceptionUi: perceptionUi['zh-CN'], mindEditorUi: mindEditorUi['zh-CN'], memorySettingsUi: memorySettingsUi['zh-CN'], memoryMaintenanceUi: memoryMaintenanceUi['zh-CN'], calendarUi: calendarUi['zh-CN'], mindUi: mindUi['zh-CN'], scheduleUi: scheduleUi['zh-CN'], adminLlmUi: adminLlmUi['zh-CN'], personalityUi: personalityUi['zh-CN'], adminAnalyticsUi: adminAnalyticsUi['zh-CN'], adminStorageUi: adminStorageUi['zh-CN'], adminRuntimeUi: adminRuntimeUi['zh-CN'], adminUsageUi: adminUsageUi['zh-CN'], adminAgentUi: {}, agentConfigUi: {}, configUi: { ...configUi['zh-CN'], ...configExtraUi['zh-CN'] }, adminExtraUi: adminExtraUi['zh-CN'], adminEmailUi: adminEmailUi['zh-CN'], subscriptionUi: subscriptionUi['zh-CN'] },
  ...
  'en-US': { ...enUS, terminalUi: terminalUi['en-US'], filesUi: filesUi['en-US'], filesViewUi: filesViewUi['en-US'], profileGuguUi: profileGuguUi['en-US'], chatUi: chatUi['en-US'], perceptionUi: perceptionUi['en-US'], mindEditorUi: mindEditorUi['en-US'], memorySettingsUi: memorySettingsUi['en-US'], memoryMaintenanceUi: memoryMaintenanceUi['en-US'], calendarUi: calendarUi['en-US'], mindUi: mindUi['en-US'], scheduleUi: scheduleUi['en-US'], adminLlmUi: adminLlmUi['en-US'], personalityUi: personalityUi['en-US'], adminAnalyticsUi: adminAnalyticsUi['en-US'], adminStorageUi: adminStorageUi['en-US'], adminRuntimeUi: adminRuntimeUi['en-US'], adminUsageUi: adminUsageUi['en-US'], adminAgentUi: {}, agentConfigUi: {}, configUi: { ...configUi['en-US'], ...configExtraUi['en-US'] }, adminExtraUi: adminExtraUi['en-US'], adminEmailUi: adminEmailUi['en-US'], subscriptionUi: subscriptionUi['en-US'] },
}
