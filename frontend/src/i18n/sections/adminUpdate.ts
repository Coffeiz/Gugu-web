export const adminUpdateUi = {
  'zh-CN': {
    ...
    checkItems: { docker: 'Docker daemon', compose: 'Compose 配置', app: '当前应用', updater: '受限更新器', dependencies: '数据库与 Redis', database_migrations: '数据库迁移状态', storage: '用户数据与配置卷', configuration: '管理员配置', disk: '可用磁盘空间', architecture: '镜像架构', signature: '发布签名', current_version: '当前版本识别', minimum_version: '最低升级版本' },
  ...
  'ja-JP': {
    ...
    checkItems: { docker: 'Docker daemon', compose: 'Compose 設定', app: '現在のアプリ', updater: '制限付き更新器', dependencies: 'データベースと Redis', database_migrations: 'データベース移行状態', storage: 'ユーザーデータと設定ボリューム', configuration: '管理者設定', disk: '空き容量', architecture: 'イメージアーキテクチャ', signature: 'リリース署名', current_version: '現在のバージョン識別', minimum_version: '最低アップグレードバージョン' },
