      ...
      <section class="permission-group">
        ...
        <div class="permission-list">
          <div class="permission-item">
            ...
            <ToggleSwitch :model-value="agent.shell_enabled === true" :disabled="!sandboxEnabled" :aria-label="t('agent.shell')" @update:model-value="setAgentFlag('shell_enabled', $event)" />
          </div>
          ...
          <div class="permission-item">
            ...
            <ToggleSwitch :model-value="agent.shell_autopilot_enabled === true" :disabled="!sandboxEnabled || agent.shell_enabled !== true" :aria-label="t('agent.autopilot')" @update:model-value="setAgentFlag('shell_autopilot_enabled', $event)" />
          </div>
          ...
          <div class="permission-item">
            ...
            <ToggleSwitch :model-value="agent.shell_system_enabled === true" :disabled="!sandboxEnabled || agent.shell_enabled !== true" :aria-label="t('agent.systemShell')" @update:model-value="setAgentFlag('shell_system_enabled', $event)" />
          </div>
          ...
          <div class="permission-item">
            ...
            <ToggleSwitch :model-value="agent.shell_dangerous_enabled === true" :disabled="!sandboxEnabled || agent.shell_enabled !== true" :aria-label="t('agent.dangerousShell')" @update:model-value="setAgentFlag('shell_dangerous_enabled', $event)" />
          </div>
        </div>
      </section>
    </div>
