<template>
  <section class="config-card">
    ...
    <div class="behavior-grid">
      <div class="behavior-item"><div class="behavior-label"><span>{{ t('memorySettingsUi.system') }}</span><span class="behavior-desc">{{ t('memorySettingsUi.systemHint') }}</span></div><AgentMemoryToggle v-model="agentDraft.memory_enabled" :ariaLabel="t('memorySettingsUi.toggleSystem')" /></div>
