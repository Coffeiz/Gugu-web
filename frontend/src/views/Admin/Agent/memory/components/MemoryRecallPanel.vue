...
.source-stack{flex-direction:column;align-items:stretch;gap:10px}.source-stack .behavior-label{flex-direction:row;align-items:baseline;gap:10px}.source-row{display:flex;flex-wrap:wrap;align-items:center;gap:6px;justify-content:flex-start}.source-chip,.source-bulk-btn{cursor:pointer;border:1px solid var(--choice-chip-border);font:500 12px var(--font-sans);user-select:none;transition:color var(--motion-hover-control) var(--motion-ease-standard),background-color var(--motion-hover-control) var(--motion-ease-standard),border-color var(--motion-hover-control) var(--motion-ease-standard)}.source-chip.active{font-weight:600}.source-chip:disabled,.source-bulk-btn:disabled{opacity:.45;cursor:not-allowed;pointer-events:none}.source-bulk{display:flex;gap:6px;margin-left:8px}.source-bulk-btn{white-space:nowrap}
</style>
