...
export function useUsage() {
  ...
  const metrics = [{ key: 'calls', label: '对话次数', unit: '次' }, { key: 'tokens_in', label: '输入 tokens', unit: '' }, { key: 'tokens_out', label: '输出 tokens', unit: '' }, { key: 'cache_read', label: '命中缓存', unit: '' }, { key: 'cache_write', label: '写入缓存', unit: '' }]
