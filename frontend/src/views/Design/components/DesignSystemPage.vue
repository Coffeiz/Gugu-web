...
const semanticGroups = [
  ...
  {title:'Action',description:'Iris 只承担动作。',tokens:[{label:'Primary',name:'--action-primary',usage:'主按钮前景',demo:'action'},{label:'Fill',name:'--action-primary-bg',usage:'主按钮 / 今日日期底色',demo:'action'},{label:'Hover',name:'--action-primary-hover',usage:'主操作 hover',demo:'action'},{label:'Selection',name:'--selection-bg',usage:'选中背景',demo:'surface'}]},
...
const tokenIndex = [
  ...
  {title:'Components',items:['--sidebar-item-active','--topbar-bg','--danger-button-fg','--danger-button-bg','--danger-button-bg-hover','--danger-button-border','--danger-button-border-hover','--motion-hover-micro','--motion-hover-control','--motion-hover-card','--card-motion','--card-overlay-motion','--calendar-grid-line','--calendar-weekend-bg','--calendar-today-date-bg','--scrollbar-track','--scrollbar-thumb','--scrollbar-thumb-hover','--scrollbar-overlay-right-offset','--scrollbar-column-right-offset','--scrollbar-overlay-z-index','--scrollbar-overlay-modal-z-index','--scrollbar-overlay-transition','--scrollbar-overlay-track-inset','--project-card-shadow','--project-card-motion','--gugu-chat-bg','--gugu-chat-sidebar-bg','--gugu-fab-bg']},
]
...
.component-strip{grid-template-columns:repeat(5,minmax(0,1fr))}.contract-card{min-height:94px;display:flex;align-items:center;gap:var(--space-md);padding:var(--space-lg);border:1px solid var(--design-card-border);border-radius:var(--design-card-radius);background:var(--design-card-bg)}.contract-icon{width:38px;height:38px;display:grid;place-items:center;flex-shrink:0;border-radius:var(--radius-sm);color:var(--action-primary);background:var(--action-soft)}.contract-icon.gugu{color:var(--content-on-accent);background:var(--gugu-fab-bg)}.contract-icon.danger{color:var(--danger-button-fg);background:var(--danger-button-bg);border:1px solid var(--danger-button-border)}.contract-card div{min-width:0;display:flex;flex-direction:column;gap:var(--space-xs)}.contract-card strong{font-size:var(--font-size-sm)}.contract-card small{font-size:var(--font-size-xs);color:var(--content-tertiary)}.danger-contract-btn{margin-left:auto;flex-shrink:0;padding:6px 11px;border:1px solid var(--danger-button-border);border-radius:var(--danger-button-radius);color:var(--danger-button-fg);background:var(--danger-button-bg);font:600 var(--font-size-xs) var(--font-sans);transition:background-color var(--motion-hover-control) var(--motion-ease-standard),border-color var(--motion-hover-control) var(--motion-ease-standard)}.danger-contract-btn:hover{background:var(--danger-button-bg-hover);border-color:var(--danger-button-border-hover)}
...
@media(max-width:1100px){.theme-matrix,.token-grid,.semantic-grid,.elevation-grid,.component-strip{grid-template-columns:repeat(2,minmax(0,1fr))}.scrollbar-demo-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.index-groups{grid-template-columns:1fr}.sample-sidebar{width:188px}.product-frame{grid-template-columns:188px 1fr}.sample-search{display:none}}
@media(max-width:760px){.design-hero{position:fixed;flex-direction:column;align-items:flex-start}.design-content{padding-top:calc(112px + var(--space-xl))}.hero-copy p{white-space:normal}.theme-matrix,.token-grid,.semantic-grid,.elevation-grid,.component-strip,.scrollbar-demo-grid{grid-template-columns:1fr}.foundation-split{grid-template-columns:1fr}.product-frame{grid-template-columns:1fr}.sample-sidebar{display:none}.sample-board{grid-template-columns:repeat(4,220px);overflow-x:auto}.sample-topbar{left:var(--space-md);right:var(--space-md)}.sample-title span,.sample-ghost{display:none}.type-row{grid-template-columns:1fr;padding:var(--space-sm) 0}.radius-row{grid-template-columns:repeat(3,1fr)}}
