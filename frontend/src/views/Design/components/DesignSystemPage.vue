...
.contract-card{min-height:94px;display:flex;align-items:center;gap:var(--space-md);padding:var(--space-lg);border:1px solid var(--design-card-border);border-radius:var(--design-card-radius);background:var(--design-card-bg)}.contract-icon{width:38px;height:38px;display:grid;place-items:center;flex-shrink:0;border-radius:var(--radius-sm);color:var(--action-primary);background:var(--action-soft)}.contract-icon.gugu{color:var(--content-on-accent);background:var(--gugu-fab-bg)}.contract-card div{display:flex;flex-direction:column;gap:var(--space-xs)}.contract-card strong{font-size:var(--font-size-sm)}.contract-card small{font-size:var(--font-size-xs);color:var(--content-tertiary)}
