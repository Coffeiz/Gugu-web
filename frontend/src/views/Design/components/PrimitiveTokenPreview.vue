...
<style scoped>
.primitive-preview { max-width: 1180px; margin: 0 auto 36px; }
...
.primitive-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: var(--space-2); }
...
.color-list, .space-list, .font-list, .radius-list, .shadow-list { display: grid; gap: var(--space-2); }
...
@media (max-width: 760px) { .primitive-heading { align-items: start; flex-direction: column; gap: 6px; } .primitive-grid { grid-template-columns: 1fr; } }
</style>
