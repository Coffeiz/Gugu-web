...
export const tokenCatalog: DesignToken[] = [
  ...
  { name: 'Pearl 050', variable: '--palette-pearl-050', category: 'primitive', type: 'color', description: 'V2 最浅暖灰紫表面。' },
  { name: 'Pearl 100', variable: '--palette-pearl-100', category: 'primitive', type: 'color', description: 'V2 浅色页面底。' },
  { name: 'Pearl 200', variable: '--palette-pearl-200', category: 'primitive', type: 'color', description: 'V2 浅色边界层。' },
  { name: 'Pearl 300', variable: '--palette-pearl-300', category: 'primitive', type: 'color', description: 'V2 中性分隔层。' },
  { name: 'Pearl 500', variable: '--palette-pearl-500', category: 'primitive', type: 'color', description: 'V2 中性辅助文字。' },
  { name: 'Pearl 700', variable: '--palette-pearl-700', category: 'primitive', type: 'color', description: 'V2 深色辅助文字。' },
  { name: 'Pearl 900', variable: '--palette-pearl-900', category: 'primitive', type: 'color', description: 'V2 深色正文。' },
  { name: 'Iris 100', variable: '--palette-iris-100', category: 'primitive', type: 'color', description: 'V2 品牌浅色背景。' },
  { name: 'Iris 300', variable: '--palette-iris-300', category: 'primitive', type: 'color', description: 'V2 品牌柔和边界。' },
  { name: 'Iris 500', variable: '--palette-iris-500', category: 'primitive', type: 'color', description: 'V2 品牌主色原子值。' },
  { name: 'Iris 700', variable: '--palette-iris-700', category: 'primitive', type: 'color', description: 'V2 品牌深色交互。' },
  { name: 'Iris 900', variable: '--palette-iris-900', category: 'primitive', type: 'color', description: 'V2 品牌最深层。' },
