...
const { selectedIds, previewFileIds, cbStore, handleFileClick, openCtx, fileListIcon, fileIconColor, renamingFileId, renameText, commitRename, cancelRename, startRenameFile, downloadFile, deleteSingleFile, isExtractableArchive, extractFile, inSelectionMode } = props.context
</script>
