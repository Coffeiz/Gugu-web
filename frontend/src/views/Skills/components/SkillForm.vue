...
.form-head { display:flex; justify-content:space-between; align-items:flex-start; padding-right:calc(var(--card-close-safe-area) - var(--space-xl)); margin-bottom:20px; }.form-head h2 { font-size:20px; margin:0; }.form-head p { color:var(--content-secondary); font-size:12px; margin:6px 0 0; }
